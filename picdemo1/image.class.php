       ...
       $info  = $this->getImageInfo($image);
         if($info !== false) {
			...
			//	$imageFun($thumbImg,$thumbname02,100);
                ...
                $thumbImg01 = imagecreatetruecolor(310,310);
                imagecopyresampled($thumbImg01,$thumbImg,0,0,$_REQUEST['x'],$_REQUEST['y'],310,310,$_REQUEST['w'],$_REQUEST['h']);

			//	$thumbImg02 = imagecreatetruecolor(48,48);
            //    imagecopyresampled($thumbImg02,$thumbImg,0,0,$_REQUEST['x'],$_REQUEST['y'],48,48,$_REQUEST['w'],$_REQUEST['h']);
...
//	./uploads/2011/6/23/201106231015231234985802.jpg	----->裁剪的小头像	160*160
